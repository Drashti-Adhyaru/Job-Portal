...
<div className="grid sm:mx-20  ">
  ...
  <div className={ `mt-6 flex items-center justify-end gap-x-2 ${ job?.userId === uerid? "bock":"hidden"} `} >
    <Button type="button" href="/user/dashboard" className="rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Edit</Button>
    <div>
    <Applyjob/>
    </div>
  </div>
