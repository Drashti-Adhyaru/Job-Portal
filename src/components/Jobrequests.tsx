...
> 
          ...
          <Button  variant="destructive" onClick={() => onChangeStatue("rejected", req[0]._id)}>Reject</Button>
          <Button onClick={() => onChangeStatue("accepted",req[0]._id)} className="bg-green-800 ml-4"> Accept</Button> 
                  ...
                  {truncateText(req[0].aboutYou,70)}
                  </p>
                </div>
